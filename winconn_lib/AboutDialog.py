...
class AboutDialog(Gtk.AboutDialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('AboutWinconnDialog')
        new_object = builder.get_object("about_winconn_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        to finish initializing the start of the new AboutWinconnDialog
        instance.
